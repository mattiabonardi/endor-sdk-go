...
func NewEntityService(microServiceId string, services *[]sdk.EndorServiceInterface, repository *sdk.EntityRepositoryInterface, logger *sdk.Logger, priority int, hybridEntitiesEnabled bool, dynamicEntitiesEnabled bool) sdk.EndorServiceInterface {
	...
	if hybridEntitiesEnabled || dynamicEntitiesEnabled {
		hybridActions["update"] = sdk.NewAction(entityService.replaceHybrid, "Replace an existing entity of type "+string(sdk.EntityTypeHybrid))
		hybridSpecializedActions["update"] = sdk.NewAction(entityService.replaceHybridSpecialized, "Replace an existing entity of type "+string(sdk.EntityTypeHybridSpecialized))
	}
	if dynamicEntitiesEnabled {
		...
		dynamicActions["update"] = sdk.NewAction(entityService.replaceDynamic, "Replace an existing entity of type "+string(sdk.EntityTypeDynamic))
		...
		dynamicSpecializedActions["update"] = sdk.NewAction(entityService.replaceDynamicSpecialized, "Replace an existing entity of type "+string(sdk.EntityTypeDynamicSpecialized))
...
func (h *EntityService) replaceHybrid(c *sdk.EndorContext[sdk.ReplaceByIdDTO[sdk.EntityHybrid]]) (*sdk.Response[sdk.EntityInterface], error) {
	return h.replace(sdk.ReplaceByIdDTO[sdk.EntityInterface]{
		Id:   c.Payload.Data.ID,
		Data: &c.Payload.Data,
	}, sdk.EntityTypeHybrid, sdk.NewSchema(sdk.EntityHybrid{}))
}

func (h *EntityService) replaceHybridSpecialized(c *sdk.EndorContext[sdk.ReplaceByIdDTO[sdk.EntityHybridSpecialized]]) (*sdk.Response[sdk.EntityInterface], error) {
	return h.replace(sdk.ReplaceByIdDTO[sdk.EntityInterface]{
		Id:   c.Payload.Data.ID,
		Data: &c.Payload.Data,
...
func (h *EntityService) replaceDynamic(c *sdk.EndorContext[sdk.ReplaceByIdDTO[sdk.EntityHybrid]]) (*sdk.Response[sdk.EntityInterface], error) {
	return h.replace(sdk.ReplaceByIdDTO[sdk.EntityInterface]{
		Id:   c.Payload.Data.ID,
		Data: &c.Payload.Data,
	}, sdk.EntityTypeDynamic, sdk.NewSchema(sdk.EntityHybrid{}))
...
func (h *EntityService) replaceDynamicSpecialized(c *sdk.EndorContext[sdk.ReplaceByIdDTO[sdk.EntityHybridSpecialized]]) (*sdk.Response[sdk.EntityInterface], error) {
	return h.replace(sdk.ReplaceByIdDTO[sdk.EntityInterface]{
		Id:   c.Payload.Data.ID,
		Data: &c.Payload.Data,
	}, sdk.EntityTypeDynamicSpecialized, sdk.NewSchema(sdk.EntityHybridSpecialized{}))
...
func (h *EntityService) replace(dto sdk.ReplaceByIdDTO[sdk.EntityInterface], entityType sdk.EntityType, schema *sdk.RootSchema) (*sdk.Response[sdk.EntityInterface], error) {
	entity, err := h.repository.Replace(&entityType, dto)
	if err != nil {
		return nil, err
	}
	return sdk.NewResponseBuilder[sdk.EntityInterface]().AddData(entity).AddSchema(sdk.NewSchema(schema)).AddMessage(sdk.NewMessage(sdk.ResponseMessageGravityInfo, fmt.Sprintf("entity %s replaced", dto.Id))).Build(), nil
}
